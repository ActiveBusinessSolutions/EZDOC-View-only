...
export class Common {
  ...
  static BASE_URL = Domain.BACKEND;
  ...
  static pages = [
    {
      path: '/pages/dashboard', title: 'Home', description: '', align: 'left', active: false, show: 'logged_out',
      children: null
    },
    {
      path: '#2', title: 'Client', description: '', align: 'left', active: false, show: 'logged_in',
      children: [
        {path: '/pages/client/create', title: 'New Client', description: '', align: 'left', active: false,},
        {path: '/pages/client/list', title: 'Client List', description: '', align: 'left', active: false,},
        {
    ...
    {
      path: '#1', title: 'Law Firm', description: '', align: 'left', active: false, show: 'logged_in',
      children: [
        {
    ...
    {
      path: '/pages/about', title: 'About', description: '', align: 'left', active: false,
      children: null
    },
    {
      path: '/pages/contact_us', title: 'Contact', description: '', align: 'left', active: false,
      children: null
    },
    {
      path: '/account/login', title: 'Log In', description: '', align: 'right', active: false, show: 'logged_out',
      children: null
    },
    {
      path: '/account/type', title: 'Sign Up', description: '', align: 'right', active: false, show: 'logged_out',
      children: null
    },
  ];
  ...
  static americanDate(phpDate, seprator = '/') {
    ...
    if (Common.isNone(phpDate) || phpDate == '0000-00-00' || dateArray.length != 3) {
      return "";
    }
